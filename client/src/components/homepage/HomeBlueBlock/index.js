          ...
          <div className="home-blue-block" style={{
            ...
            {/* <img src={favWhite}></img> */}
              <div className="bb-text-content">
                ...
                <p>Almost 1 in 5 adults suffer from a mental illness. In 2017, roughly 46.6 million people were diagnosed with mental health issues in the United States alone. If you or someone you know struggles with mental health, know that you are not alone.</p>
              </div>
