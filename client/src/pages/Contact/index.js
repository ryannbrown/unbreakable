        ...
        <Row>
          ...
          >
            ...
            <div className="contact-box">
              ...
              <button onClick={this.openModal} className="contact-btn-link-contactpage">
                Email us
              </button>
            </div>
          </Col>
          ...
          <div className="modal-canvas">
            <div className="contact-modal">
              ...
              <div className="modal-content">
                ...
                <div>
                  {/* <br></br> */}
                  {emailSent ? <p>Your message has been sent</p> : <div></div>}
                  {errorMsg ? (
                    <Alert variant="danger">
                      There was trouble accessing email server. Email us
                      directly at info@blueheronculinary.com
                    </Alert>
                  ) : (
                    <div></div>
                  )}
